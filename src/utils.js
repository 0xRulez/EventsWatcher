class Utils {
    ...
    consoleInfo = (messageLog, TColor, newLine = false) => {
        console.log(TColor, messageLog)
    ...
    getEventDate = async (timestamp) => {
        const intFromHex = await this.getIntFromHex(timestamp);
        const date = new Date(intFromHex * 1000)
